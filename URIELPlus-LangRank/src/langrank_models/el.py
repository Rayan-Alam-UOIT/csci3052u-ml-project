...
TIMING_LOG_PATH = f"langrank_el_timing_log_{args.mode}.txt"
...
features_all = [
    ...
    'Transfer over target size ratio','GENETIC','SYNTACTIC','FEATURAL','PHONOLOGICAL','INVENTORY','GEOGRAPHIC','MORPHOLOGICAL','SCRIPT'
]
